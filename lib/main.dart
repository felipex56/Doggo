...
class _UploaderState extends State<Uploader> {
  final FirebaseStorage _storage = FirebaseStorage(
      storageBucket: 'gs://doggo-7621c.appspot.com/');
            ...
            if (snapshot.data != null) {
              return Column(
                children: [
                  ...
                  if((snapshot.data.snapshot.bytesTransferred /
                      snapshot.data.snapshot.totalByteCount * 100).toInt() !=
                      100)
                    Padding(
                  ...
                  Text(
                      '${(snapshot.data.snapshot.bytesTransferred /
                          snapshot.data.snapshot.totalByteCount * 100)
                          .toStringAsFixed(2)}% '
                  ),
                ],
              );
